...
/**
 * <p>
 *  Class meant to keep some constants related to the version of the atomichash library
...
public final class AtomicHash {
    ...
    static {
        ...
        try {
            ...
            properties.load(
                    ClassLoaderUtils.loadResourceAsStream("io/aquen/atomichash/atomichash.properties"));
